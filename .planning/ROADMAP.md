...
- [x] 01-04-PLAN.md — Every content page reachable: homepage, How It Works with the FAQ folded in, About, Schedule, Contact shell, and the Learn section

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 01-05-PLAN.md — Accessible, mobile-first, and pushed: WCAG 2.1 AA sweep, whole-phase verification, README, and the final push
